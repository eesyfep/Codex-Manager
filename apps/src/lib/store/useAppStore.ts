...
export const useAppStore = create<AppState>((set) => ({
  ...
  appSettings: {
    ...
    modelForwardRules: "",
    modelRouterProbeFallbackModels: "gpt-5.4,gpt-5.5",
    accountMaxInflight: 1,
    accountCooldownSeconds: 20,
    woolEnabled: true,
    woolMaxInflightPerApi: 2,
    woolPoolMaxInflight: 6,
    woolPreflightWorkers: 3,
    woolCooldownSeconds: 600,
    woolPreflightTtlSeconds: 300,
    woolFailureThreshold: 1,
