...
pub(crate) fn write_request_log_with_attempts(
    ...
    super::trace_log::log_failed_request(super::trace_log::FailedRequestLog {
        ...
        service_tier,
        upstream_url,
        routed_from: trace_context.routed_from,
        initial_aggregate_api_id,
        attempted_aggregate_api_ids_json: attempted_aggregate_api_ids_json.as_deref(),
        aggregate_api_supplier_name: trace_context.aggregate_api_supplier_name,
        aggregate_api_url: trace_context.aggregate_api_url,
        status_code,
        error,
        duration_ms,
    });
    ...
    let (request_log_id, token_stat_error) = match storage.insert_request_log_with_token_stat(
        &RequestLog {
            ...
            conversation_id: trace_context.conversation_id.map(|v| v.to_string()),
